...
int main()
{
    ...
    int b[6] = {1, 3, 5}; // Keeping the array incomplete to see what is the outcome result. cout << "Partial Initialized Int Array B" << endl ;
    ...
    float d[6] = {12.6, 82.4, 43.6, 4.54, 77.48, 84.88}; // No need to know the type of array. cout << "Completely Initialized Float Array D with auto: " << endl;
